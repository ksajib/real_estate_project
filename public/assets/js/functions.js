    ...
    (SEMICOLON.initialize = {
        ...
        responsiveClasses: function() {
            if ("undefined" == typeof jRespond)
                return (
                    console.log("responsiveClasses: jRespond not Defined."), !0
                );
            jRespond([
            ...
            e || (e = 700),
                ...
                $goToTopEl.off("click").on("click", function() {
                    return (
                        $("body,html")
                            .stop(!0)
                            .animate({ scrollTop: 0 }, Number(e), t),
                        !1
                    );
                });
        },
        ...
        lazyLoad: function() {
            var e = $("[data-lazyload]");
            if (!$().appear)
                return console.log("lazyLoad: Appear not Defined."), !0;
            e.length > 0 &&
                e.each(function() {
                    var e = $(this),
                        t = e.attr("data-lazyload");
                    e
                        .attr("src", "public/assets/images/blank.svg")
                        .css({
                            background:
                                "url(public/assets/images/preloader.gif) no-repeat center center #FFF"
                        }),
                        e.appear(
                            function() {
        ...
        setFullColumnWidth: function(e) {
            if (!$().isotope)
                return (
                    console.log("setFullColumnWidth: Isotope not Defined."), !0
                );
            if ((e.css({ width: "" }), e.hasClass("portfolio-full"))) {
                ...
                (a = e.innerWidth()) == windowWidth &&
                    ((a = 1.005 * windowWidth), e.css({ width: a + "px" }));
                i = a / t;
                (i = Math.floor(i)) * t >= a &&
                    e.css({ "margin-right": "-1px" }),
                    e.children("a").css({ width: i + "px" });
            ...
            superfish: function() {
                if (
                    ...
                    $(
                        ...
                        popUpSelector:
                            "ul,.mega-menu-content,.top-link-section",
                        delay: 250,
                        speed: 350,
                        ...
                        ($("#primary-menu.sub-title > ul > li").hover(
                            ...
                            function() {
                                $(this)
                                    ...
                                    .css({
                                        backgroundImage:
                                            'url("public/assets/images/icons/menu-divider.png")'
                                    });
                            }
                        ),
                ...
                $headerWrap.hasClass("not-dark")
                    ...
                    $header.hasClass("sticky-header") &&
                        (defaultStickyLogo &&
                            defaultLogo
                                .find("img")
                                .attr("src", defaultStickyLogo),
                        retinaStickyLogo &&
                            retinaLogo
                                .find("img")
                                .attr("src", retinaStickyLogo)),
                    ($body.hasClass("device-sm") ||
                        $body.hasClass("device-xs")) &&
                        (defaultMobileLogo &&
                            defaultLogo
                                .find("img")
                                .attr("src", defaultMobileLogo),
                        retinaMobileLogo &&
                            retinaLogo
                                .find("img")
                                .attr("src", retinaMobileLogo));
            },
            ...
            sliderParallaxDimensions: function() {
                ...
                if (
                    ...
                    ($sliderParallaxEl.hasClass("revslider-wrap") ||
                        $sliderParallaxEl.find(".carousel-widget").length >
                            0) &&
                        ((e = $sliderParallaxEl
                            .find(".slider-parallax-inner")
                            .children()
                ...
                $sliderEl.each(function() {
                    if ($(this).hasClass("swiper_wrapper")) {
                        ...
                        if (
                            ...
                            var elementPagination = element.find(
                                    ".swiper-pagination"
                                ),
                        ...
                        var elementNavNext = element.find(
                                ".slider-arrow-right"
                            ),
                    ...
                    if (t + e + 50 > $window.scrollTop())
                        if (
                            ...
                            if (
                                ...
                                (a = (($window.scrollTop() - e) / 1.5).toFixed(
                                    0
                                )),
                                    (i = (
                                        ($window.scrollTop() - e) /
            ...
            loadItem: function(e, t, a) {
                ...
                if (0 == a) {
                    ...
                    $portfolioDetailsContainer.load(
                        o,
                        { portid: e, portnext: i, portprev: s },
                        function() {
            ...
            initializeAjax: function(e) {
                (prevPostPortId = $("#" + e)),
                    ...
                    $("#close-portfolio")
                        ...
                        .on("click", function() {
                            return (
                                $portfolioDetailsContainer.fadeOut(
                                    "600",
                                    function() {
                                        $portfolioDetails
                                            .find("#portfolio-ajax-single")
        ...
        (SEMICOLON.widget = {
                    ...
                    e.each(function() {
                        ...
                        t || (t = "slide"),
                            ...
                            e.flexslider({
                                ...
                                after: function() {
                                    $(".grid-container").hasClass(
                                        "portfolio-full"
                                    ) &&
                                        ($(
                                            ".grid-container.portfolio-full"
                                        ).isotope("layout"),
                                        SEMICOLON.portfolio.portfolioDescMargin()),
                                        $(".post-grid").hasClass(
                                            "post-masonry-full"
                ...
                e.length > 0 &&
                    e.each(function() {
                        ...
                        if (
                            ...
                            o > i &&
                                t.css({ left: "", top: -(o - i) / 2 + "px" }),
                            s > a &&
                                t.css({ top: "", left: -(s - a) / 2 + "px" }),
                            SEMICOLON.isMobile.any() &&
                                !e.hasClass("no-placeholder"))
                        ) {
                            var n = t.attr("poster");
                            "" != n &&
                                e.append(
            ...
            youtubeBgVideo: function() {
                if (!$().YTPlayer)
                    return (
                        console.log(
                            "youtubeBgVideo: YoutubeBG Plugin not Defined."
                        ),
                        !0
                    );
                var e = $(".yt-bg-player");
            ...
            tabs: function() {
                ...
                e.length > 0 &&
                    e.each(function() {
                        ...
                        e.tabs({
                            active: Number(a),
                            show: { effect: "fade", duration: Number(t) }
                        });
                    });
            },
            ...
            twitterFeed: function() {
                ...
                if ("undefined" == typeof sm_format_twitter3)
                    return (
                        console.log(
                            "twitterFeed: sm_format_twitter3() not Defined."
                        ),
                        !0
                    );
                var e = $(".twitter-feed");
            ...
            flickrFeed: function() {
                if (!$().jflickrfeed)
                    return (
                        console.log("flickrFeed: jflickrfeed not Defined."), !0
                    );
                var e = $(".flickr-feed");
                e.length > 0 &&
                    e.each(function() {
            ...
            dribbbleShots: function(e) {
                if (!$.jribbble)
                    return (
                        console.log("dribbbleShots: Jribbble not Defined."), !0
                    );
                if (!$().imagesLoaded)
                    return (
            ...
            carousel: function() {
                if (!$().owlCarousel)
                    return (
                        console.log("carousel: Owl Carousel not Defined."), !0
                    );
            ...
            masonryThumbsArrange: function(e) {
                if (!$().isotope)
                    return (
                        console.log(
                            "masonryThumbsArrange: Isotope not Defined."
                        ),
                        !0
                    );
            ...
            notifications: function(e) {
                if ("undefined" == typeof toastr)
                    return (
                        console.log("notifications: Toastr not Defined."), !0
                    );
                toastr.remove();
                var t = $(e),
            ...
            ajaxForm: function() {
                if (!$().validate)
                    return (
                        console.log("ajaxForm: Form Validate not Defined."), !0
                    );
                if (!$().ajaxSubmit)
                    return (
                        console.log("ajaxForm: jQuery Form not Defined."), !0
                    );
                    ...
                    i.css({ width: e }),
                        setTimeout(function() {
                            h.css({ width: t }),
                                ...
                                i
                                    .clone()
                                    .appendTo(a.find(".scw-ticker-wrap-clone"));
                        }, 300),
                        o || (o = 3e4),
                        (n = "false" != n);
                    var p = t / windowWidth;
            ...
            stickySidebar: function() {
                if (!$().scwStickySidebar)
                    return (
                        console.log(
                            "stickySidebar: Sticky Sidebar is not Defined."
                        ),
                        !0
                    );
